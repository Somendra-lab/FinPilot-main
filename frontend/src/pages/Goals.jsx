  ...
  return <Layout>
      <div className="goals-page">
        ...
        {showForm && <form onSubmit={handleSubmit} className="goal-form card">
            ...
            <div className="form-grid">
            ...
            })} required placeholder="e.g., Save for Vacation" />
              </div>
              <div className="form-group">
                <label>Target Amount</label>
                <input type="number" step="0.01" value={formData.targetAmount} onChange={e => setFormData({
              ...formData,
              ...
              <div className="form-group">
                ...
                <input type="date" value={formData.deadline} onChange={e => setFormData({
              ...formData,
          ...
          })} placeholder="Add notes about this goal" rows={3}></textarea>
            </div>
