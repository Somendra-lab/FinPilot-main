        ...
        {showForm && (<form onSubmit={handleSubmit} className="budget-form card">
            ...
            <div className="form-grid">
              <div className="form-group">
                ...
                <input type="text" value={formData.category} onChange={(e) => setFormData({ ...formData, category: e.target.value })} required placeholder="e.g., Groceries"/>
              </div>
              <div className="form-group">
                <label>Monthly Limit</label>
                <input type="number" step="0.01" value={formData.limit} onChange={(e) => setFormData({ ...formData, limit: e.target.value })} required placeholder="0.00"/>
              </div>
            </div>
