...
export default function DeveloperProfile() {
    ...
    const contacts = [
        { icon: '📱', label: 'Phone', value: '+91 8400029870', href: 'tel:+918400029870' },
        { icon: '✉️', label: 'Email', value: 'somendraprataps966@gmail.com', href: 'mailto:somendraprataps966@gmail.com' },
        { icon: '💼', label: 'LinkedIn', value: 'linkedin.com/in/somendra-pratap-singh', href: 'https://www.linkedin.com/in/somendra-pratap-singh-923842344' }
    ];
      ...
      <div className="container">
        <motion.div variants={containerVariants} initial="hidden" animate={inView ? 'visible' : 'hidden'} className="developer-profile">
          ...
          <motion.div variants={itemVariants} className="profile-contacts">
            {contacts.map((contact, idx) => (<motion.a key={idx} href={contact.href} target="_blank" rel="noopener noreferrer" className="contact-item card-glassmorphic" whileHover={{ y: -3, transition: { duration: 0.2 } }}>
