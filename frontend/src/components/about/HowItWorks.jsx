...
export default function HowItWorks() {
  ...
  const steps = [{
    ...
    desc: 'Sign up securely with email and password'
  }, {
    number: '2',
    title: 'Track Income',
    desc: 'Add your income sources and amounts'
  }, {
    number: '3',
    title: 'Record Expenses',
    desc: 'Log daily expenses by category'
  }, {
    number: '4',
    title: 'Analyze Health',
    desc: 'View AI-powered financial insights'
  }, {
    number: '5',
    title: 'Get Recommendations',
    desc: 'Receive personalized financial advice'
  }, {
    number: '6',
    title: 'Achieve Goals',
    desc: 'Monitor progress toward your targets'
  }];
